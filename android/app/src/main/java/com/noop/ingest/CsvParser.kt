...
internal object HeaderNorm {
    ...
    private val foreignAliases: Map<String, String> = mapOf(
        ...
        //   (same folded form) so it is NOT repeated here — a duplicate key would shadow, not extend. —
        ...
        "pct_de_oxigenio_no_sangue" to "blood_oxygen_pct",   // "% de oxigênio no sangue" → leading % → pct_…

...
final class WhoopExportImporterTests: XCTestCase {
    ...
    // MARK: - Localized (Brazilian Portuguese) column headers

    func testPortugueseHeaderNormalizationAliases() {
        // Diacritic-folded Portuguese headers map onto the canonical English keys.
    ...
    func testPortugueseCyclesValuesParse() throws {
        // The EXACT ciclos_fisiológicos.csv header from a real Brazilian Portuguese export + one data row.
        let csv = """

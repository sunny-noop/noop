...
we control — not strap frames. The real-strap validation (PPG-RMSSD 111 vs cloud 110) lives in the project
analysis, not in unit tests.
"""
import math
...
def test_spot_hrv_returns_none_on_noise():
